  ...
  return (
    <>
     <h1 className=' text-center'>fees Data</h1>
        ...
        {
          show ? <form method="" action="" className='updateform' onSubmit={(e)=>submit(e)}>
          <label>SID<span>*</span></label>
            <input type="text" name='SID' autoComplete='off'  onChange={(e)=>handle(e)} value={data.SID} ></input>
          <label >Fees</label>
          <input type="text" name="Fees" value={data.Fees} onChange={(e) => handle(e)}></input>
          <label >AdminName</label>
          <input type="text" name="AdminName" value={data.AdminName} onChange={(e) => handle(e)}></input>
          <label >Installment </label>
          <input type="text" name="Installment" value={data.Installment} onChange={(e) => handle(e)}></input>
        <input type='submit' value="SAVE" className='btn-info mt-2' onClick={(e)=>updateuser(e)}></input>
         </form>  : ""
        }
         <button onClick={()=>setshow(!show)}  className='b1 btn-info'> { show ? "X":"fees"}</button>
       {
          show ? "": <DataTable
          title="Staff list"
          columns={columns}
      ...
      <Modal
        ...
        <form method="" action="" className='updateform'>
          ...
          <input type="text" name="AdminName" value={data.AdminName} onChange={(e) => handle(e)}></input>
          <label >Date</label>
          <input type="text" name="Salary" value={data.Date} onChange={(e) => handle(e)}></input>
          <label >Installment </label>
          <input type="text" name="Installment" value={data.Installment} onChange={(e) => handle(e)}></input>
        <input type='submit' value="SAVE" className='btn-info mt-2' onClick={(e)=>updateuser(e)}></input>
         </form>
